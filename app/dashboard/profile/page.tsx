              ...
              <div className="mt-6 space-y-4 text-sm text-slate-300">
                <div className="rounded-3xl border border-[color:var(--border-soft)] bg-[color:var(--bg-dark-navy)] p-4">
                  ...
                  <p className="mt-3 text-sm text-slate-400">
                    To reset your password, contact admin support via Telegram at{' '}
                    <a href="https://t.me/ATLASCAPITALco" target="_blank" rel="noopener noreferrer" className="text-[color:var(--primary-gold)] underline">
                      t.me/ATLASCAPITALco
                    </a>
                    .
                  </p>
