        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-3xl border border-[color:var(--primary-gold)]/30 bg-[color:var(--surface)] p-7 shadow-2xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href={WITHDRAWAL_ADMIN_EMAIL} target="_blank" rel="noopener noreferrer" className="rounded-2xl bg-[color:var(--primary-gold)] px-4 py-3 text-sm font-semibold text-[color:var(--bg-dark-navy)]">Contact via Telegram</a>
